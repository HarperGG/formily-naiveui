...
const ICON_MAP = {
  info: () =>
    h(NIcon, {}, { default: () => h(InformationCircleOutline, {}, {}) }),
  error: () => h(NIcon, {}, { default: () => h(CloseCircleOutline, {}, {}) }),
  success: () =>
    h(NIcon, {}, { default: () => h(CheckmarkCircleOutline, {}, {}) }),
  warning: () => h(NIcon, {}, { default: () => h(WarningOutline, {}, {}) }),
}
